...
naughty.config.defaults.font = "Adwaita Mono 16"
...
favoritesmenu = {
  { "Chromium", function() awful.spawn("chromium") end },
  { "Terminal", function() awful.spawn(terminal) end },
  { "Vesktop", function() awful.spawn("vesktop") end },
  { "Bitwarden", function() awful.spawn("bitwarden") end },
  { "WeeChat", terminal .. " -e weechat" },
  { "btm", terminal .. " -e btm" },
  { "battop", terminal .. " -e battop" }
}
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(wallpaper, s, "#000000", 0.5)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({                   }, "XF86AudioMute", function () awful.spawn("wpctl set-mute @DEFAULT_SINK@") end,
...
awful.util.spawn("heylisten")
awful.util.spawn("tailscale systray")
